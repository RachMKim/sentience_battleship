  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <h2 className="text-2xl font-display text-white tracking-wider mb-2">ROOM CREATED</h2>
        <p className="text-ocean-400 text-sm mb-6">Share this code with your opponent</p>

        <motion.button
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          onClick={copyCode}
          className="w-full py-4 px-6 bg-ocean-800 rounded-xl border border-neon-blue/30
