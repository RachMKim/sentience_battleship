  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <h2 className="text-2xl font-display text-white tracking-wider mb-2 text-3d">{t('room_created')}</h2>
        ...
        <p className="text-ocean-500 text-xs mt-3 mb-8">
          {copied
            ? <span className="text-neon-green" style={{ textShadow: '0 0 6px rgba(0,255,136,0.4)' }}>{t('copied')}</span>
            : t('click_to_copy')}
        </p>

        <p className="text-ocean-400 text-sm mb-6">{t('waiting_opponent')}</p>
